...
public class NpcAPI implements Serializable {
	...
	public static void SaveNPC() {
		try (ObjectOutputStream so = new ObjectOutputStream(new FileOutputStream("PlikNPC.ser"));) {
	...
	public static void LoadNPC() {
		...
		try (ObjectInputStream is = new ObjectInputStream(new FileInputStream("PlikNPC.ser"));) {
